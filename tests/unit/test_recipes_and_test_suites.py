...
def test_nightly_compute_stays_below_4720_hours(nightly_test_suite, tracker):
    ...
    assert total_gpu_hours <= 4720, (
        f"Total GPU hours exceeded 4720: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
